...
export function ValueStackingSection() {
  const items = [
    ...
    { label: "Community Manager (Veille)", price: "500€ / mois" },
  ...
  return (
    <section className="px-6">
      ...
      >
        <h3 className="font-geist text-[32px] font-medium text-[#0f172a] text-center mb-8">
        ...
        <div className="line-through text-gray-400 text-right mt-6 font-geist font-medium">
          Valeur : +17 000€ / an
        </div>
        
        <div className="font-instrument italic text-[28px] text-[#0f172a] text-center mt-10">
