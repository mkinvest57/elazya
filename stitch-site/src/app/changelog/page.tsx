    ...
    return (
        <div className="container mx-auto px-4 py-24 md:py-32 max-w-3xl">
            ...
            <p className="text-xl text-foreground/60 text-center mb-16">
                L'évolution constante d'Alizé, pour une IA toujours plus performante.
            </p>
                ...
                <div className="relative">
                    ...
                    <Card className="p-6">
                        ...
                        <ul className="list-disc pl-6 space-y-2 text-foreground/70 text-sm">
                            ...
                            <li>Nouveau système de design "Stitch 2.0" ultra-fluide.</li>
                ...
                <div className="relative opacity-60">
                    ...
                    <Card className="p-6">
                        ...
                        <p className="text-sm text-foreground/70">
                            Alizé peut maintenant lire et écrire dans vos Apple Notes directement.
                        </p>
                    </Card>
                </div>
            </div>
