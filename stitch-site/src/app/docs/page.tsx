    ...
    const sections = [
        {
            ...
            title: "Bienvenue",
            group: "Introduction",
            content: "Elazya est votre assistant personnel local. Contrairement aux IA cloud, Elazya vit sur votre machine, respecte votre vie privée et ne nécessite pas d'abonnement mensuel."
        },
        {
            id: "installation",
            title: "Installation",
            group: "Introduction",
            content: "Pour installer Elazya, téléchargez le binaire depuis votre dashboard, décompressez-le et lancez l'exécutable. Aucune configuration complexe n'est requise."
        },
        {
            id: "premiers-pas",
            title: "Premier pas",
            group: "Introduction",
            content: "Une fois lancé, connectez Elazya à votre application de messagerie préférée (WhatsApp, Telegram ou Slack) en scannant le QR code affiché."
        },
        {
            id: "email",
            title: "Email & Calendrier",
            group: "Utilisation",
            content: "Elazya peut lire vos emails, résumer les conversations importantes et ajouter des événements à votre calendrier directement depuis vos messages."
        },
        {
            id: "search",
            title: "Web Search",
            group: "Utilisation",
            content: "Posez simplement une question à Elazya. Il effectuera une recherche web sécurisée et vous fournira une réponse synthétisée avec les sources."
        },
        {
            id: "notes",
            title: "Apple Notes",
            group: "Utilisation",
            content: "Synchronisez vos idées. Elazya peut créer, modifier et organiser vos notes dans Apple Notes via des commandes vocales ou textuelles."
        }
    ]
    ...
    return (
        <div className="container mx-auto px-4 py-24 md:py-32 flex flex-col lg:flex-row gap-12">
            ...
            <main className="flex-1 max-w-3xl space-y-20">
                <section>
                    <h1 className="text-4xl md:text-5xl font-bold mb-6">Documentation Elazya</h1>
                    <p className="text-xl text-foreground/60 mb-8">
                        Apprenez à maîtriser Elazya et transformez votre façon de travailler avec l'IA locale.
                    </p>
                        ...
                        <div className="prose prose-invert max-w-none">
                            ...
                            {section.id === "installation" && (
                                <div className="bg-surface-2 p-6 rounded-xl border border-surface-3 font-mono text-sm overflow-x-auto">
                                    ...
                                    <p>curl -sSf https://elazya.com/install.sh | sh</p>
                                </div>
                            )}
                            {section.id === "email" && (
