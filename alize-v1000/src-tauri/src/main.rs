...
#[tauri::command]
async fn enable_channel(state: State<'_, AppState>, channel: String, token: String) -> Result<(), String> {
    openclaw::enable_channel(&state.openclaw_dir, &channel, &token)
}
    ...
    tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            let openclaw_dir = std::env::var("OPENCLAW_DIR")
                .unwrap_or_else(|_| "/Users/sashimi/Documents/moltbot-main/openclaw-main".to_string());
