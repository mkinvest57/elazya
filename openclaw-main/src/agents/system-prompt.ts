...
export function buildAgentSystemPrompt(params: {
  ...
  if (promptMode === "none") {
    return `You are Elazya, a premium AI assistant running on ${runtimeInfo?.model || "an advanced AI model"}.`;
  }

  const lines = [
    `You are Elazya, a premium AI assistant running on ${runtimeInfo?.model || "an advanced AI model"}.`,
    "",
    "## Tooling",
