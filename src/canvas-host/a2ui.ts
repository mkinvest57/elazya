...
export const A2UI_PATH = "/__alize__/a2ui";
export const CANVAS_HOST_PATH = "/__alize__/canvas";
export const CANVAS_WS_PATH = "/__alize/ws";
...
(() => {
  ...
  const handlerNames = ["alizeCanvasA2UIAction", "${legacyHandlerName}"];
  ...
  globalThis.Alizé = globalThis.Alizé ?? {};
  globalThis.Alizé.postMessage = postToNode;
  globalThis.Alizé.sendUserAction = sendUserAction;
  globalThis.alizePostMessage = postToNode;
  globalThis.alizeSendUserAction = sendUserAction;
  globalThis.alizePostMessage = postToNode;
  globalThis.alizeSendUserAction = sendUserAction;
