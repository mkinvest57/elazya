...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.ALIZE_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: AlizeConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: AlizeConfig): string {
...
function mergeTelegramAccountConfig(cfg: AlizeConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: AlizeConfig): ResolvedTelegramAccount[] {
