...
export function listBindings(cfg: AlizeConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: AlizeConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: AlizeConfig) {
