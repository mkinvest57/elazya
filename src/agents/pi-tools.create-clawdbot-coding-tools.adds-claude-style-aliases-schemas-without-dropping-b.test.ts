...
describe("createAlizeCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createAlizeCodingTools({
      config,
    ...
    const anthropicTools = createAlizeCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createAlizeCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createAlizeCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
