...
function resolveAvatarSource(cfg: AlizeConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: AlizeConfig, agentId: string): AgentAvatarResolution {
