...
import type { AlizeConfig, SkillConfig } from "../../config/config.js";
...
export function resolveConfigPath(config: AlizeConfig | undefined, pathStr: string) {
...
export function isConfigPathTruthy(config: AlizeConfig | undefined, pathStr: string): boolean {
...
function isBundledSkill(entry: SkillEntry): boolean {
  return entry.skill.source === "alize-bundled";
}

export function resolveBundledAllowlist(config?: AlizeConfig): string[] | undefined {
