  ...
  it("includes hardening and resource flags", () => {
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        ...
        "alize.sandbox=1",
        "--label",
        "alize.sessionKey=main",
        "--label",
        "alize.createdAtMs=1700000000000",
        "--label",
        "alize.sandboxBrowser=1",
        "--read-only",
        "--tmpfs",
        "/tmp",
        "--network",
