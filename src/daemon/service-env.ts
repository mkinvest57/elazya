...
export function buildServiceEnvironment(params: {
  ...
  return {
    ...
    ALIZE_PROFILE: profile,
    ALIZE_STATE_DIR: env.ALIZE_STATE_DIR,
    ALIZE_CONFIG_PATH: env.ALIZE_CONFIG_PATH,
    ALIZE_GATEWAY_PORT: String(port),
    ALIZE_GATEWAY_TOKEN: token,
    ALIZE_LAUNCHD_LABEL: resolvedLaunchdLabel,
    ALIZE_SYSTEMD_UNIT: systemdUnit,
    ALIZE_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    ALIZE_SERVICE_KIND: GATEWAY_SERVICE_KIND,
    ALIZE_SERVICE_VERSION: VERSION,
  };
}
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    ALIZE_STATE_DIR: env.ALIZE_STATE_DIR,
    ALIZE_CONFIG_PATH: env.ALIZE_CONFIG_PATH,
    ALIZE_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    ALIZE_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    ALIZE_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    ALIZE_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    ALIZE_LOG_PREFIX: "node",
    ALIZE_SERVICE_MARKER: NODE_SERVICE_MARKER,
    ALIZE_SERVICE_KIND: NODE_SERVICE_KIND,
    ALIZE_SERVICE_VERSION: VERSION,
  };
}
