export const LEGACY_PROJECT_NAME = "alize" as const;
...
export const LEGACY_MACOS_APP_SOURCES_DIR = "apps/macos/Sources/Alizé" as const;

export const MACOS_APP_SOURCES_DIR = "apps/macos/Sources/Alizé" as const;
