...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "alize-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<AlizeConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<AlizeConfig["telegram"]>>,
