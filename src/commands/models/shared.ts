...
export async function updateConfig(
  mutator: (cfg: AlizeConfig) => AlizeConfig,
): Promise<AlizeConfig> {
...
export function resolveModelTarget(params: { raw: string; cfg: AlizeConfig }): {
  provider: string;
  model: string;
} {
...
export function buildAllowlistSet(cfg: AlizeConfig): Set<string> {
