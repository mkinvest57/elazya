...
export function applyZaiConfig(cfg: AlizeConfig): AlizeConfig {
...
export function applyOpenrouterProviderConfig(cfg: AlizeConfig): AlizeConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: AlizeConfig): AlizeConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: AlizeConfig): AlizeConfig {
...
export function applyOpenrouterConfig(cfg: AlizeConfig): AlizeConfig {
...
export function applyMoonshotProviderConfig(cfg: AlizeConfig): AlizeConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMoonshotConfig(cfg: AlizeConfig): AlizeConfig {
...
export function applyKimiCodeProviderConfig(cfg: AlizeConfig): AlizeConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: AlizeConfig): AlizeConfig {
...
export function applySyntheticProviderConfig(cfg: AlizeConfig): AlizeConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: AlizeConfig): AlizeConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: AlizeConfig): AlizeConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: AlizeConfig): AlizeConfig {
