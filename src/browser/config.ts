import type { BrowserConfig, BrowserProfileConfig, AlizeConfig } from "../config/config.js";
import {
 ...
 *
 * Note: this is a Alizé browser profile (routing config), not a Chrome user profile.
