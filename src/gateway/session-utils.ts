...
import { type AlizeConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: AlizeConfig): string[] {
...
export function listAgentsForGateway(cfg: AlizeConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: AlizeConfig): string {
  return normalizeAgentId(resolveDefaultAgentId(cfg));
}

export function resolveSessionStoreKey(params: { cfg: AlizeConfig; sessionKey: string }): string {
...
function resolveSessionStoreAgentId(cfg: AlizeConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: AlizeConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: AlizeConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: AlizeConfig): GatewaySessionsDefaults {
