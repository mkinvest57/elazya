...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: AlizeConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: AlizeConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: AlizeConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  clear(cfg?: AlizeConfig): void {
    this.cache.clear();
    if (cfg) this.lastConfigRef = cfg;
  }

  private resetIfConfigChanged(cfg: AlizeConfig): void {
