...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "alize-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveAlizePackageRoot } = await import("./alize-root.js");
    ...
    vi.mocked(resolveAlizePackageRoot).mockResolvedValue("/opt/alize");
