...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof AlizeConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: AlizeConfig; env: NodeJS.ProcessEnv }): {
  cfg: AlizeConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
