...
export function resolveTtsConfig(cfg: AlizeConfig): ResolvedTtsConfig {
...
export function resolveTtsPrefsPath(config: ResolvedTtsConfig): string {
  ...
  const envPath = process.env.ALIZE_TTS_PREFS?.trim();
...
export function buildTtsSystemPromptHint(cfg: AlizeConfig): string | undefined {
