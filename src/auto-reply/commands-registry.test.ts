...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@alize", { botUsername: "alize" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@alize args", {
        botUsername: "alize",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "alize" })).toBe(
      "/help@otherbot",
    );
  });
