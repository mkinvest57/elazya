...
function resolveMentionPatterns(cfg: AlizeConfig | undefined, agentId?: string): string[] {
  if (!cfg) return [];
...
export function buildMentionRegexes(cfg: AlizeConfig | undefined, agentId?: string): RegExp[] {
