...
export const DEFAULT_LOG_DIR = "/tmp/alize";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "alize.log"); // legacy single-file path

const LOG_PREFIX = "alize";
...
function resolveSettings(): ResolvedSettings {
  let cfg: AlizeConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => AlizeConfig;
      };
