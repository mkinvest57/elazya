...
export const PLUGIN_MANIFEST_FILENAME = "alize.plugin.json";
...
// package.json "alize" metadata (used for onboarding/catalog)
...
export type AlizePackageManifest = {
  extensions?: string[];
...
): AlizePackageManifest | undefined {
  if (!manifest) return undefined;
  return manifest.alize ?? manifest[LEGACY_MANIFEST_KEY];
}
