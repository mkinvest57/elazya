...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @alize/voice-call -> voice-call).
...
function addCandidate(params: {
  ...
  params.candidates.push({
    ...
    packageAlizé: getPackageManifestMetadata(manifest ?? undefined),
  });
}
...
export function discoverAlizePlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExt = path.join(workspaceRoot, ".alize", "extensions");
    discoverInDirectory({
      dir: workspaceExt,
      origin: "workspace",
