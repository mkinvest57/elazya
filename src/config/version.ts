...
export function parseAlizeVersion(raw: string | null | undefined): AlizeVersion | null {
  if (!raw) return null;
...
export function compareAlizeVersions(
  a: string | null | undefined,
  b: string | null | undefined,
): number | null {
  const parsedA = parseAlizeVersion(a);
  const parsedB = parseAlizeVersion(b);
