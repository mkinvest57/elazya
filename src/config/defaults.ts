...
function resolveAnthropicDefaultAuthMode(cfg: AlizeConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: AlizeConfig): AlizeConfig {
...
export function applyTalkApiKey(config: AlizeConfig): AlizeConfig {
...
export function applyModelDefaults(cfg: AlizeConfig): AlizeConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: AlizeConfig): AlizeConfig {
...
export function applyLoggingDefaults(cfg: AlizeConfig): AlizeConfig {
...
export function applyContextPruningDefaults(cfg: AlizeConfig): AlizeConfig {
...
export function applyCompactionDefaults(cfg: AlizeConfig): AlizeConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) return cfg;
