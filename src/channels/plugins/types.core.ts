...
export type ChannelAgentToolFactory = (params: { cfg?: AlizeConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: AlizeConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: AlizeConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: AlizeConfig }) => boolean;
  supportsCards?: (params: { cfg: AlizeConfig }) => boolean;
