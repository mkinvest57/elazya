...
export function listChannelMessageActions(cfg: AlizeConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: AlizeConfig): boolean {
  for (const plugin of listChannelPlugins()) {
...
export function supportsChannelMessageCards(cfg: AlizeConfig): boolean {
  for (const plugin of listChannelPlugins()) {
