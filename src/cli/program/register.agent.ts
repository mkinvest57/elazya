...
${formatHelpExamples([
  ['alize agent --to +15555550123 --message "status update"', "Start a new session."],
  ['alize agent --agent ops --message "Summarize logs"', "Use a specific agent."],
  [
    'alize agent --session-id 1234 --message "Summarize inbox" --thinking medium',
    "Target a session with explicit thinking level.",
  ],
  [
    'alize agent --to +15555550123 --message "Trace logs" --verbose on --json',
    "Enable verbose logging and JSON output.",
  ],
  ['alize agent --to +15555550123 --message "Summon reply" --deliver', "Deliver reply."],
  [
    'alize agent --agent ops --message "Generate report" --deliver --reply-channel slack --reply-to "#reports"',
...
${theme.heading("Examples:")}
${formatHelpExamples([
  ['alize agents set-identity --agent main --name "Clawd" --emoji "🌬️"', "Set name + emoji."],
  ["alize agents set-identity --agent main --avatar avatars/clawd.png", "Set avatar path."],
  ["alize agents set-identity --workspace ~/clawd --from-identity", "Load from IDENTITY.md."],
  [
    "alize agents set-identity --identity-file ~/clawd/IDENTITY.md --agent main",
