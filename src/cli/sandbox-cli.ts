...
const SANDBOX_EXAMPLES = {
  main: [
    ["alize sandbox list", "List all sandbox containers."],
    ["alize sandbox list --browser", "List only browser containers."],
    ["alize sandbox recreate --all", "Recreate all containers."],
    ["alize sandbox recreate --session main", "Recreate a specific session."],
    ["alize sandbox recreate --agent mybot", "Recreate agent containers."],
    ["alize sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["alize sandbox list", "List all sandbox containers."],
    ["alize sandbox list --browser", "List only browser containers."],
    ["alize sandbox list --json", "JSON output."],
  ],
  recreate: [
    ["alize sandbox recreate --all", "Recreate all containers."],
    ["alize sandbox recreate --session main", "Recreate a specific session."],
    ["alize sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["alize sandbox recreate --browser --all", "Recreate only browser containers."],
    ["alize sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["alize sandbox explain", "Show effective sandbox config."],
    ["alize sandbox explain --session agent:main:main", "Explain a specific session."],
    ["alize sandbox explain --agent work", "Explain an agent sandbox."],
    ["alize sandbox explain --json", "JSON output."],
  ],
} as const;
