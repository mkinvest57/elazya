        ...
        <div className="docs-page bg-background text-white min-h-screen font-sans">
            ...
            <nav className="sticky top-0 z-50 bg-background/70 backdrop-blur-lg border-b border-glass-border py-4">
                <div className="container mx-auto px-5 flex justify-between items-center">
                    <div className="text-2xl font-bold flex items-center">
                        🌬️ Alizé <span className="text-xs opacity-50 ml-2.5 font-normal tracking-widest bg-white/10 px-2 py-0.5 rounded">DOCS</span>
                    </div>
                    <div className="flex gap-6 items-center">
                        ...
                        <a href="#buy" className="btn-secondary py-2 px-4 text-sm">Acheter</a>
                    </div>
                </div>
            </nav>
            ...
            <div className="flex min-h-screen pt-[80px]">
                ...
                <main className="ml-[250px] p-16 max-w-4xl flex-1">
                    <h1 className="text-5xl font-bold mb-8">Bienvenue sur Alizé</h1>
                    <p className="text-lg opacity-90 mb-6 leading-relaxed">
                        Alizé est votre assistant personnel local, conçu pour respecter votre vie privée tout en augmentant votre productivité de manière exponentielle.
                    </p>

                    <div className="glass-card p-8 mb-12 bg-primary/10 border-primary/30">
                        <strong>🚀 En Bref :</strong> Alizé tourne 100% sur votre machine. Elle utilise Gemini 2.5 Flash pour une rapidité extrême et peut interagir avec vos fichiers, votre terminal et vos applications.
                    </div>

                    <h2 className="text-3xl font-bold mt-12 mb-6">Installation Rapide</h2>
                    <p className="mb-4">Copiez-collez cette commande dans votre terminal pour installer Alizé (Mac/Linux) :</p>
                    ...
                    <div className="bg-black/30 border border-glass-border rounded-xl p-6 font-mono my-6 relative group">
                        ...
                        <code>curl -sL https://get.alize.ai/install | bash</code>
                    </div>
